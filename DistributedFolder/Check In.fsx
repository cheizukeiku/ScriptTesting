...
<node f="42" dt="4"><name>Check In 1</name><data>
 ...
 <node f="42"><name>stats</name>
  ...
  <node f="42"><name>state_profiles</name>
   ...
   <node f="42" dt="7"><name>Availability</name><data/>
    ...
    <node f="200000042"><name>onChange</name>
     <node f="40"><name></name></node>
     <node f="200000042" dt="3"><name></name><data><coupling>/Check In 1&gt;stats/HC_Availability_States/dependencies/_2</coupling></data>
      <node f="40"><name></name></node></node>
    </node>
   </node>
   <node f="42" dt="7"><name>HC States</name><data/>
    ...
    <node f="200000042"><name>onChange</name>
     <node f="40"><name></name></node>
     <node f="200000042" dt="3"><name></name><data><coupling>/Check In 1&gt;stats/HC_Availability_States/dependencies/_1</coupling></data>
      <node f="40"><name></name></node></node>
    </node>
   </node>
  </node>
  <node f="42" dt="7"><name>HC_Availability_States</name><data/>
   ...
   <node f="42"><name>dependencies</name>
    <node f="40"><name></name></node>
    <node f="42" dt="3"><name>_1</name><data><coupling>/Check In 1&gt;stats/state_profiles/HC States/onChange/1</coupling></data></node>
    <node f="42" dt="3"><name>_2</name><data><coupling>/Check In 1&gt;stats/state_profiles/Availability/onChange/1</coupling></data></node>
   </node>
  </node>
...
treenode processFlow = ownerobject(activity);
 ...
 <node f="42"><name>Groups</name>
  <node f="40"><name></name></node>
  <node f="800000042" dt="3"><name>_1</name><data><coupling>/Tools/Groups/Locations/_1</coupling></data>
   <node f="40"><name></name></node></node>
  <node f="800000042" dt="3"><name>_2</name><data><coupling>/Tools/Groups/Check In Counters/_1</coupling></data></node>
 </node>
